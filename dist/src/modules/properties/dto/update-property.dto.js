...
class UpdatePropertyDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { title: { required: false, type: () => String, minLength: 3 }, description: { required: false, type: () => String, minLength: 10 }, location: { required: false, type: () => String }, price: { required: false, type: () => Number, minimum: 0 }, images: { required: false, type: () => [require("./image.dto").ImageDto] } };
    }
}
